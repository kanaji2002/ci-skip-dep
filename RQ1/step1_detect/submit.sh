#!/bin/bash -l
#SBATCH --job-name=rq1_step1_detect
...
# Python スクリプトへの引数をそのまま転送
PYTHON_ARGS="$*"

OUT_DIR="/work/rintaro-k/research/RQ1/batch_output/${SLURM_JOB_NAME:-rq1_step1_detect}/${SLURM_JOB_ID:-local}"
mkdir -p "$OUT_DIR"
