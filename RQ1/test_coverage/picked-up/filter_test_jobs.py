...
OUTPUT_CSV = "results_has_test_jobs.csv"
WORK_DIR   = "repos_sparse"
PROGRESS   = "filter_progress.log"
    ...
    for wf_path in sorted(
        ...
        try:
            ...
            for job_id, job_def in jobs.items():
                ...
                # job_id または job_name の単語がキーワードと一致するか含むか
                for kw in TEST_KEYWORDS:
                    if kw in str(job_id) or kw in job_name:
