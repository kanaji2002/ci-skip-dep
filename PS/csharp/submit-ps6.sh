#!/bin/bash -l
#SBATCH --job-name=ps6-filter-csharp
...
# Setup directories
# ============================================
OUT_DIR="/work/rintaro-k/research/PS/csharp/batch/output/${SLURM_JOB_NAME:-ps6-filter-csharp}/${SLURM_JOB_ID:-local}"
mkdir -p "$OUT_DIR"
...
# ============================================
echo ""
echo "=== Starting PS6 filter (C# / size < 10MB) ==="
