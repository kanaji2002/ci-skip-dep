...
Input : ps4/ps4_filtered.csv
Check : size < 10MB (GitHub API の size カラムは KB 単位)
Output: ps5/ps5_filtered.csv
"""
...
INPUT_CSV  = BASE_DIR / "ps4" / "ps4_filtered.csv"
OUTPUT_DIR = BASE_DIR / "ps5"
OUTPUT_CSV = OUTPUT_DIR / "ps5_filtered.csv"
