"""
GitHub 上の Python リポジトリ（スター数 10 以上）を収集し、
results/python-repo.csv に保存するスクリプト。
...
OUTPUT_CSV = os.path.join(BASE_DIR, "results", "python-repo.csv")
SEARCH_URL = "https://api.github.com/search/repositories"

BASE_LANGUAGE = "language:Python"
STAR_MIN = 10
