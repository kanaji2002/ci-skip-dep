#!/usr/bin/env python3
"""
RQ3-1_analyze_job_python.py - Python step2_results.csv を集約して精度指標を出力する
...
使い方:
    python3 RQ3-1_analyze_job_python.py
    python3 RQ3-1_analyze_job_python.py --input /path/to/step2_results.csv
"""
...
DEFAULT_INPUT = os.path.join(
    _DIR, "..", "RQ3-1", "Code", "python", "output", "step2_results.csv"
)
