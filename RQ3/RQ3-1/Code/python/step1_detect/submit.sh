#!/bin/bash -l
#SBATCH --job-name=rq3_1_py_step1
...
JOB_LABEL="${SLURM_JOB_NAME:-rq3_1_py_step1}${BATCH_INDEX:+_idx${BATCH_INDEX}}"

OUT_DIR="/work/rintaro-k/research/RQ3/RQ3-1/Code/python/batch_output/${JOB_LABEL}/${SLURM_JOB_ID:-local}"
mkdir -p "$OUT_DIR"
...
cd /work/rintaro-k/research/RQ3/RQ3-1/Code/python/step1_detect
