...
TEST_LIB_BLOCKLIST: set = {
    "criterion", "proptest", "quickcheck", "mockall", "rstest",
    "assert_cmd", "predicates", "insta", "trybuild", "tempfile",
    "serial_test", "tokio-test", "wiremock", "httpmock", "mockito",
    "cargo-tarpaulin", "cargo-nextest",
}
